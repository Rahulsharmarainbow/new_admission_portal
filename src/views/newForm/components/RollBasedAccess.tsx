// RollBasedAccess component में rankCardState handle करें
...
const RollBasedAccess: React.FC<RollBasedAccessProps> = ({ formData, updateFormData }) => {
  ...
  const accessCards = [
    ...
    {
      title: "Give Access For Rank Card Access", 
      description: "Provide access to rank card management",
      field: 'rankCardState',
      checked: formData.rankCardState
    }
  ];
