          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <TextInput
                ...
                placeholder="Enter Email"
                color={
                  errors[`${contact.prefix}Email`] ? "failure" : 
                  (contact.data.email && !validateEmail(contact.data.email) ? "failure" : "gray")
                }
                helperText={errors[`${contact.prefix}Email`]}
                className="w-full"
              />
            </div>
            <div>
              ...
              <TextInput
                ...
                placeholder="Enter Phone"
                color={
                  errors[`${contact.prefix}Phone`] ? "failure" : 
                  (contact.data.phone && !validatePhone(contact.data.phone) ? "failure" : "gray")
                }
                helperText={errors[`${contact.prefix}Phone`]}
                className="w-full"
              />
            </div>
            <div>
