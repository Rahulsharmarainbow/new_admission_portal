...
//       // Add academic_id (required by API)
//       formDataToSend.append('academic_id', jobDetails.academic_id.toString());
      
//       // Add candidate_details as individual fields with 'candidate_details[' prefix
//       // This matches what your curl command shows
//       Object.keys(formData).forEach(key => {
//         const value = formData[key];
...
//         } else if (value !== null && value !== undefined) {
//           // Add each candidate detail with the 'candidate_details[' prefix
...
//         const referenceInfo = response.data.reference_id ? 
//           `\nReference ID: ${response.data.reference_id}` : '';
        
//         toast.success(
//           `${successMessage}${referenceInfo}`
//         );
...
//                     {/* Submit button - REMOVED STATUS CHECK */}
//                     <button
//                       type="submit"
//                       disabled={isSubmitting}
            ...
            {/* <div className="bg-blue-50 rounded-2xl p-5 mb-6 text-left">
              ...
              <ul className="space-y-2 text-sm text-slate-700">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>You'll receive updates at the email you provided</span>
                </li>
                <li className="flex items-start gap-2">
                  <svg className="w-4 h-4 text-blue-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span>Our HR team may contact you for next steps</span>
                </li>
              </ul>
            </div> */}
...
export const ApplyJobPage: React.FC = () => {
  ...
  const handleSuccessPopupClose = () => {
    ...
    // Navigate back after closing popup
    navigate(-1);
  };
