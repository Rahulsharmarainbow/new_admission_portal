...
const BannerFormModal: React.FC<BannerFormModalProps> = ({
      ...
      if (banner) {
        setFormData({
          ...
          banner_image_preview: banner.banner_image ? 
            `${apiAssetsUrl}${banner.banner_image}` : '',
        });
      } else {
        setFormData({
  ...
  }, [isOpen, banner, user, apiAssetsUrl]);
        ...
        <ModalBody className="px-6 py-4 max-h-[60vh] overflow-y-auto">
          <div className="space-y-6">
            ...
            {(user?.role === 'SuperAdmin' || user?.role === 'SupportAdmin') && (
              <div>
                <div className="mb-2">
                  <Label htmlFor="academic_id" className="block text-sm font-medium text-gray-900">
            ...
            <div>
              <div className="mb-2">
                <Label htmlFor="banner_image" className="block text-sm font-medium text-gray-900">
            ...
            <div ref={colorPickerRef}>
              <div className="mb-2">
                <Label htmlFor="color_code" className="block text-sm font-medium text-gray-900">
              ...
              <div className="relative">
                <div className="flex items-center gap-3 mb-2">
                  <button
                    type="button"
                    className="w-12 h-12 rounded-lg border border-gray-300 cursor-pointer shadow-sm hover:border-blue-500 transition-colors"
            ...
            <div>
              <div className="mb-2">
                <Label htmlFor="redirect_url" className="block text-sm font-medium text-gray-900">
                  Redirect URL
              ...
              <TextInput
                ...
                disabled={loading}
                helperText="Optional: Enter URL where users will be redirected when clicking the banner"
                className="w-full"
              />
            </div>
          </div>
