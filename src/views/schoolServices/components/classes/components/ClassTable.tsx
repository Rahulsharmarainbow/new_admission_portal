...
// import Breadcrumb from 'src/Frontend/Common/BreadcrumbHeader';
...
//       {/* Search Bar with Filters and Add Button - POSITIONS EXCHANGED */}
...
//                 S.NO
//               </th>
//               <th scope="col" className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer select-none" onClick={() => handleSort('class_name')}>
//                 <div className="flex items-center">
//                   Class Name {getSortIcon('class_name')}
//                 </div>
//               </th>
//               <th scope="col" className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer select-none" onClick={() => handleSort('tution_fee_1')}>
//                 <div className="flex items-center">
//                   Tution Fee 1 {getSortIcon('tution_fee_1')}
//                 </div>
//               </th>
//               <th scope="col" className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer select-none" onClick={() => handleSort('tution_fee_2')}>
//                 <div className="flex items-center">
//                   Tution Fee 2 {getSortIcon('tution_fee_2')}
//                 </div>
//               </th>
//               <th scope="col" className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer select-none" onClick={() => handleSort('tution_fee_3')}>
//                 <div className="flex items-center">
//                   Tution Fee 3 {getSortIcon('tution_fee_3')}
//                 </div>
//               </th>
//               <th scope="col" className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer select-none" onClick={() => handleSort('available_seat')}>
//                 <div className="flex items-center">
...
//                       {filters.search || filters.academic_id ? 'Try adjusting your search criteria' : 'No classes available'}
//                     </p>
                    ...
                    filteredAcademics.map((academic) => (
                      <button
                        ...
                        className={`w-full px-3 py-2 text-left hover:bg-gray-100 truncate ${
                          filters.academic_id === academic.id.toString() ? 'bg-blue-50 text-blue-600' : ''
                        }`}
                      >
                        {academic.academic_name}
                      </button>
