...
const ClassForm: React.FC<ClassFormProps> = ({
  ...
  return (
    <Modal show={isOpen} onClose={onClose} size="lg">
      <div className="flex flex-col h-[70vh] sm:h-auto sm:max-h-[80vh]">
        {/* Form Header */}
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            ...
            <div>
              ...
              {errors.availableSeat && (
                <p className="text-red-500 text-sm mt-1">{errors.availableSeat}</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div>
                ...
                />
                {errors.tution_fee_1 && (
                  <p className="text-red-500 text-sm mt-1">{errors.tution_fee_1}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.tution_fee_2 && (
                  <p className="text-red-500 text-sm mt-1">{errors.tution_fee_2}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.tution_fee_3 && (
                  <p className="text-red-500 text-sm mt-1">{errors.tution_fee_3}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.registration_fees && (
                  <p className="text-red-500 text-sm mt-1">{errors.registration_fees}</p>
                )}
              </div>
            </div>
          </form>
