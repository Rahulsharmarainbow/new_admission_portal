...
// const SchoolDataExport: React.FC = () => {
//   const { user } = useAuth();
//   const [formData, setFormData] = useState({
//     school_id: '', // "all" or specific academic ID
//     startDate: '',
//     endDate: ''
//   });
...
//         {/* Header Section */}
//         {/* <div className="mb-6">
//           <h1 className="text-2xl font-bold text-gray-800 mb-2">Export School Data</h1>
//           <p className="text-gray-600">
//             Export comprehensive school data including applications, student details, and academic information for selected date range.
//           </p>
//         </div> */}
...
//               <Label htmlFor="school" className="block mb-2 text-sm font-medium text-gray-700">
//                 Select School
//               </Label>
//               <SchoolDropdown
//                 value={formData.school_id}
//                 onChange={handleSchoolChange}
//                 placeholder="Select school or choose 'All'..."
//                 includeAllOption={true}
//                 label=""
//               />
//               {/* <p className="mt-1 text-xs text-gray-500">
//                 Select specific school or "All Schools" for complete data
//               </p> */}
//             </div>
...
//         {/* Quick Date Presets */}
//         <div className="mt-6">
//           <h3 className="text-lg font-semibold text-gray-700 mb-3">Quick Date Range</h3>
...
//               color="light"
//               onClick={() => {
//                 const start = new Date(new Date().getFullYear(), 0, 1); // Jan 1 of current year
//                 const end = new Date();
...
// export default SchoolDataExport;
...
const SchoolDataExport: React.FC = () => {
  const { user } = useAuth();
  const [formData, setFormData] = useState({
    school_id: '', // "all" or specific school ID
    startDate: '',
    endDate: ''
  });
  const [loading, setLoading] = useState(false);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-end">
            ...
            <div className="lg:col-span-1">
              ...
              <SchoolDropdown
                value={formData.school_id}
                onChange={handleSchoolChange}
                placeholder="Select school or 'All'..."
                includeAllOption={true}
                label=""
              />
          ...
          <div className="mt-4 p-3 bg-green-50 rounded-lg border border-green-200">
            <div className="flex items-center text-sm text-green-800">
              ...
              <span>
                ...
                {formData.school_id && ` • School ID: ${formData.school_id}`}
                {!formData.school_id && ` • All Schools`}
              </span>
            </div>
          </div>
        )}
