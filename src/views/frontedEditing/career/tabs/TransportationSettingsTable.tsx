...
interface TransportationSettingsTableProps {
  selectedAcademic?: string; // Optional prop
}

const TransportationSettingsTab: React.FC<TransportationSettingsTableProps> = ({ selectedAcademic }) => {
  const { user } = useAuth();
...
export default TransportationSettingsTab;