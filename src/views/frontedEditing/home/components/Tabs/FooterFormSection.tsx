...
const FooterFormSection: React.FC<FooterFormSectionProps> = ({
  ...
  // Form fields
  const [academicLogo, setAcademicLogo] = useState(null);
  ...
  if (data.logo) {
    ...
    // If your backend sends just a filename, adjust path accordingly
 ...
 const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    if (academicLogo instanceof File) {
      ...
      // Optional: send the existing logo filename (if no new file selected)
      formData.append('academic_logo', academicLogo);
    }
  ...
  <div className="flex items-center gap-4">
    ...
    />
        ...
        <div className="md:col-span-2">
            ...
            onChange={handleInputChange(setAcademicAddress)}
