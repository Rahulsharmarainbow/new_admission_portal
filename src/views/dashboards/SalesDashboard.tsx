...
const SalesDashboard = () => {
          ...
          <div className="bg-[#0085db] rounded-lg shadow-lg p-6 relative overflow-hidden border-0">
            ...
            <div className="relative z-10">
              ...
              <h4 className="text-2xl font-bold text-white mb-1">
                {dashboardData?.accountCounts?.total_demo_accounts + dashboardData?.accountCounts?.total_live_accounts || 0}
              </h4>
        ...
        <div className="lg:col-span-3 col-span-12">
          <div className="bg-[#0085db] rounded-lg shadow-lg p-6 relative overflow-hidden border-0">
            ...
            <div className="relative z-10">
              ...
              <h4 className="text-2xl font-bold text-white mb-1">
                {dashboardData?.accountCounts?.total_demo_accounts || 0}
              </h4>
              <span className="text-sm text-white text-opacity-90 font-medium">
                Total Demo Account
              </span>
        ...
        <div className="lg:col-span-3 col-span-12">
          <div className="bg-[#0085db] rounded-lg shadow-lg p-6 relative overflow-hidden border-0">
            ...
            <div className="relative z-10">
              ...
              <h4 className="text-2xl font-bold text-white mb-1">
                {dashboardData?.accountCounts?.total_live_accounts || 0}
              </h4>
              <span className="text-sm text-white text-opacity-90 font-medium">
                Total Live Account
              </span>
            ...
            <>
              <div className="overflow-x-auto rounded-lg border border-gray-200">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {dashboardData?.accountList?.map((app: any, index: number) => (
                      <tr key={app.id} className="hover:bg-gray-50 transition-colors duration-150">
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                          {(filters.page || 0) * (filters.rowsPerPage || 10) + index + 1}
                        </td>
  ...
  <span
    className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium
      ${
        app.status === 1
          ? "bg-blue-100 text-blue-800" // School
          : app.status === 2
          ? "bg-purple-100 text-purple-800" // College
          : "bg-pink-100 text-pink-800" // University
      }`}
  >
    {app.status === 1
      ? "School"
...
<td className="px-6 py-4 whitespace-nowrap">
  <span
    className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium
      ${
        app.account_type === 1
          ? "bg-yellow-100 text-yellow-800" // Demo
          : "bg-green-100 text-green-800" // Live
      }`}
  >
    {app.account_type === 1 ? "Demo" : "Live"}
  </span>
</td>
