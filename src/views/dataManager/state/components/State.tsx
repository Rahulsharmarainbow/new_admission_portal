          ...
          <table className="min-w-full divide-y divide-gray-200 p-2">
            <thead className="bg-gray-50">
              <tr>
                <th
                  scope="col"
                  className="w-60 text-center px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                >
                  S.NO
                </th>
                <th
                ...
                <tr>
                  <td colSpan={3} className="px-4 py-8 text-center text-gray-500">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <Button onClick={() => setShowAddModal(true)} color="blue" className="mt-4">
                        <svg
