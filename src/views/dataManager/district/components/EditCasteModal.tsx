...
//   // Fetch states for dropdown and caste details when modal opens
//   useEffect(() => {
//     if (isOpen) {
//       fetchStates();
//       if (selectedItem) {
...
//         setCasteTitle(response.data.data.district_title || '');
//         // If the API returns state information, set it here
//         // setSelectedState(response.data.data.state_id || '');
//       } else {
//         alert('Failed to fetch caste details');
//         onClose();
//       }
//     } catch (error: any) {
//       console.error('Error fetching caste details:', error);
//       alert('Failed to fetch caste details. Please try again.');
//       onClose();
//     } finally {
//       setFetching(false);
//     }
...
//     if (!selectedItem) {
//       alert('No caste selected for editing');
//       return;
//     }
...
//         state_id: selectedState, // Assuming your API needs state_id for caste update
//         s_id: user?.id,
//         academic_id: 65
//       };
...
//         onSuccess();
//       } else {
//         alert(response.data?.message || 'Failed to update caste');
//       }
//     } catch (error: any) {
//       console.error('Error updating caste:', error);
//       alert(error.response?.data?.message || 'Failed to update caste. Please try again.');
//     } finally {
//       setLoading(false);
//     }
//   };
