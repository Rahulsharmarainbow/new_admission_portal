        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer select-none" onClick={() => handleSort('district_title')}>
                <div className="flex items-center">
                  Caste Name {getSortIcon('district_title')}
                </div>
              </th>
              ...
              <tr>
                <td colSpan={3} className="px-6 py-8 text-center text-gray-500">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-lg font-medium text-gray-600">No castes found</p>
