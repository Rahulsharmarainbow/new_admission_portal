...
const PreviewStep: React.FC<PreviewStepProps> = ({
  ...
  const renderFieldValue = (child: any) => {
    switch (child.type) {
      ...
      case 'textarea':
        return <span className="text-gray-800 whitespace-pre-wrap">{formData[child.name] || 'Not provided'}</span>;
      ...
      case 'adhar':
        ...
        if (aadhaarNumber.length === 12) {
          ...
          return <span className="text-gray-800 font-mono">{formattedAadhaar}</span>;
        } else {
          return <span className="text-gray-800">Not provided</span>;
        }
  ...
  return (
    <div className="preview_form space-y-6">
      ...
      {/* Form Data Preview - Using same layout as FormStep */}
            ...
            {box.children
              ...
              .map((child: any, childIndex: number) => {
                ...
                const getColumnSpan = () => {
                  ...
                  if (childWidthValue >= 45) return 'large';
                  if (childWidthValue >= 30) return 'medium';
                  return 'normal';
                };

                const spanClass = {
                  'full': 'col-span-full',
                  'wide': 'col-span-full lg:col-span-2',
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`
                      ...
                      ${child.type === 'file_button' ? 'bg-transparent border-0 p-0 hover:bg-transparent' : ''}
                      ${child.type === 'checkbox' ? 'bg-transparent border-0 p-0 hover:bg-transparent' : ''}
                    `}>
