...
const Home = () => {
 ...
 {institute.header?.logo && (
  ...
  <div className="text-center">
    <h1 className="text-4xl font-bold text-gray-900 underline underline-offset-4 decoration-red-800 inline-block pb-1 uppercase">
    ...
    {institute.header?.address && (
      ...
      <div className="bg-transparent mx-8 py-8">
