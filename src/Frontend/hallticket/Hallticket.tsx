...
const HallTicket = (props) => {
  ...
  const handleDownload = async (ticketId, uniqueCode) => {
    try {
      setDownloading(ticketId);

      const response = await fetch(`${apiUrl}api/frontend/download-hall-ticket`, {
        method: 'POST',
        headers: {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(`${apiUrl}api/frontend/check-hall-ticket`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'accept': '/',
      ...
      <div className="container max-w-7xl mx-auto px-3">
        <div className="flex flex-col justify-center items-center min-h-screen bg-clr">
          ...
          {step === 1 && (
            <div className="box-brdr w-full px-3">
              ...
              <div className="flex justify-center items-center">
                <div className="w-full md:w-2/5 bg-white p-6 shadow-lg rounded-lg border border-gray-200">
          ...
          {step === 2 && (
            <div className="box-brdr w-full px-3">
              <div className="flex justify-center items-center">
                <div className="w-full md:w-3/4 bg-white p-6 shadow-lg rounded-lg border border-gray-200">
                          ...
                          hallTicketDetails.map((ticket) => (
                            <tr key={ticket.id} className="hover:bg-gray-50 border-b">
                              ...
                              <td className="py-3 px-4 text-right">
                                <button
                                  onClick={() => handleDownload(ticket.id, ticket.unique_code)}
