...
//       const response = await fetch(`${apiUrl}api/frontend/download-rank-card-by-id`, {
//         method: 'POST',
//         headers: {
...
//         },
//         body: JSON.stringify({
//           rankcard_id: ticketId,
//           academic_id: props.academic_id,
//           token: token
//         }),
//       });
...
//     try {
//       const response = await fetch(`${apiUrl}/frontend/check-rank-card`, {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
//           'accept': '/',
...
//       if (result.status) {
//         setHallTicketDetails(result.hall_ticket);
...
//         <div className="flex flex-col justify-center items-center min-h-screen container bg-clr">
       
//              {/* Header */}
//           {step === 1 && (
//             <div className="box-brdr w-full px-3">
//               <div className="heading mb-8 text-center">
//                 <h1 className="text-3xl font-bold mb-2">GENERATE RANKCARD</h1>
//                 <p className="text-gray-600">Enter your details below for RankCard Download</p>
//               </div>

//               <div className="flex justify-center items-center">
//                 <div className="w-full md:w-2/5 bg-white p-6 shadow-lg rounded-lg">
...
//                     <h1 className="text-3xl font-bold">RankCard Details</h1>
//                   </div>
...
//                           <th className="py-3 px-4 border-b text-left font-medium text-gray-700">Degree Name</th>
...
//                       </thead>
//                       <tbody>
//                         {hallTicketDetails?.length > 0 ? (
//                           hallTicketDetails?.map((ticket) => (
//                             <tr key={ticket.id} className="hover:bg-gray-50">
//                               <td className="py-3 px-4 border-b">{ticket.degree_name}</td>
//                               <td className="py-3 px-4 border-b">{ticket.roll_no}</td>
//                               <td className="py-3 px-4 border-b">{ticket.hall_ticket_no}</td>
...
//                               <h1 className="text-xl font-semibold text-gray-600">RankCard not available</h1>
//                             </td>
//                           </tr>
//                         )}
//                       </tbody>
...
//           {/* <Footer footer={props.footer} content={props.content} academic_id={props.academic_id} /> */}
//         </div>
//       </div>
//     </div>
//   );
...
//               <div className="flex justify-center items-center">
//                 <div className="w-full md:w-2/5 bg-white p-6 shadow-lg rounded-lg my-10">
//                  <div className="heading mb-8 text-center">
//                 <h1 className="text-3xl font-bold mb-2">GENERATE RANKCARD</h1>
//                 <p className="text-gray-600">Enter your details below for RankCard Download</p>
//               </div>
...
//             <div className="box-brdr w-full px-3">
//               <div className="flex justify-center items-center">
//                 <div className="w-full md:w-3/4 bg-white p-6 shadow-lg rounded-lg my-10">
//                   <div className="heading mb-6 text-center">
//                     <h1 className="text-3xl font-bold">RankCard Details</h1>
//                   </div>
...
//   const [token, settoken] = useState('');
//   const [step, setStep] = useState(1);
//   const [rankcardDetails, setRankcardDetails] = useState([]);
//   const [downloading, setDownloading] = useState(null);
//   const [loading, setLoading] = useState(false);
//   const [institute, setInstitute] = useState(null);
//   const { institute_id } = useParams();
...
//   const handleDownload = async (rankcardId) => {
//     try {
//       setDownloading(rankcardId);

//       const response = await fetch(`${apiUrl}/frontend/download-rank-card-by-id`, {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
//           'accept': '/',
...
//       if (result.status) {
//         setRankcardDetails(result.rankcard || []);
//         settoken(result.token);
//         setApplicationNumber('');
//         setName('');
//         setDob('');
//         setStep(2);
//         toast.success('Rankcard found successfully!');
//       } else {
//         toast.error(result.message || 'No rankcard found');
//         setRankcardDetails([]);
//       }
//     } catch (error) {
//       console.error('Error:', error);
...
//                           <th className="py-3 px-4 border-b text-left font-medium text-gray-700">Hall Ticket No</th>
//                           <th className="py-3 px-4 border-b text-left font-medium text-gray-700">Roll No</th>
//                           <th className="py-3 px-4 border-b text-left font-medium text-gray-700">Obtained Marks</th>
//                           <th className="py-3 px-4 border-b text-left font-medium text-gray-700">Rank</th>
//                           <th className="py-3 px-4 border-b text-right font-medium text-gray-700">Action</th>
//                         </tr>
//                       </thead>
//                       <tbody>
//                         {rankcardDetails && rankcardDetails.length > 0 ? (
//                           rankcardDetails.map((rankcard) => (
//                             <tr key={rankcard.id} className="hover:bg-gray-50">
//                               <td className="py-3 px-4 border-b">{rankcard.degree_name}</td>
//                               <td className="py-3 px-4 border-b">{rankcard.hall_ticket_no}</td>
//                               <td className="py-3 px-4 border-b">{rankcard.roll_no}</td>
//                               <td className="py-3 px-4 border-b">{rankcard.obtained_marks}</td>
//                               <td className="py-3 px-4 border-b">{rankcard.rank}</td>
//                               <td className="py-3 px-4 border-b text-right">
//                                 <button
//                                   onClick={() => handleDownload(rankcard.id)}
//                                   disabled={downloading === rankcard.id}
//                                   className="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 transition duration-200"
//                                 >
//                                   {downloading === rankcard.id ? (
//                                     <>
//                                       <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
//                                         <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
//                                         <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
...
//                         ) : (
//                           <tr>
//                             <td colSpan={6} className="py-4 px-4 border-b text-center">
//                               <h1 className="text-xl font-semibold text-gray-600">RankCard not available</h1>
//                             </td>
//                           </tr>
//                         )}
...
const Rankcard = (props) => {
  ...
  const handleDownload = async (rankcardId) => {
    try {
      ...
      const response = await fetch(`${apiUrl}/frontend/download-rank-card`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'accept': '/',
        ...
        body: JSON.stringify({
          rankcard_id: rankcardId,
          unique_code: institute_id, // Added unique_code from your API
          token: token
        }),
      });
      ...
      if (data.success) {
        ...
        toast.success('Rankcard downloaded successfully!');
      } else {
